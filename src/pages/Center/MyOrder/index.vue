                  ...
                  <tr>
                    <th colspan="5">
                      <span class="ordertitle">
                        {{order.createTime}}　订单编号：{{order.outTradeNo}} <span
                          class="pull-right delete"><img src="./images/delete.png"></span></span>
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr v-for="(item,index) in orderDetailList" :key="item.id">
                    <td width="60%">
                    ...
                    <template v-if="index===0" :rowspan="order.orderDetailList.length">
                      <td  width="8%" class="center">{{order.consignee}}</td>
                      <td  width="13%" class="center">
                        <ul class="unstyled">
                          <li>总金额¥{{order.totalAmount}}</li>
                          <li>{{order.oaymentWay==='ONLINE' ? '在线支付' : '货到付款'}}</li>
